...
def validate_commission_apply_lock(lock: dict[str, Any]) -> dict[str, Any]:
    ...
    if lock["legacy_home_retirement_continuation_v1"] != {
        ...
        "recovery_receipt_name": "05a-legacy-home-retirement.json",
    }:
        raise ValueError("legacy Lima HOME continuation contract differs")
    if lock["predecessor_media_continuation_v1"] != {
        "bundle_files": [
            "bootstrap-public.sh",
        ...
        raise ValueError("predecessor media continuation contract differs")
    expected_phases = {
    ...
    if lock["stopped_instance_adoption_continuation_v1"] != {
        ...
        "root_umask": "0077",
        "vm_create_receipt_name": "07-vm-create.json",
    }:
        raise ValueError("stopped instance adoption continuation differs")
    ...
    if lock["vm_management_ssh"] != {
        ...
        "retained_public_mode_0600_resume_v1": {
            ...
            "replacement_commission_apply_sha256": "cd071e8817a222f6edd573762e0d96db4673e00eff7202ae6119c8a7439c3646",
